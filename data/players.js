export const NHL_PLAYERS = [
  ...
  { name: 'Nikita Kucherov',     team: 'Tampa Bay Lightning',   score: 98,  rarity: 'Elite'     },
  { name: 'Cale Makar',          team: 'Colorado Avalanche',    score: 97,  rarity: 'Elite'     },
  { name: 'Leon Draisaitl',      team: 'Edmonton Oilers',       score: 96,  rarity: 'Elite'     },
  { name: 'Macklin Celebrini',   team: 'San Jose Sharks',       score: 95,  rarity: 'Elite'     },
  // Superstars
  { name: 'Quinn Hughes',        team: 'Minnesota Wild',        score: 94,  rarity: 'Superstar' },
  { name: 'Kirill Kaprizov',     team: 'Minnesota Wild',        score: 93,  rarity: 'Superstar' },
  ...
  { name: 'Jack Eichel',         team: 'Vegas Golden Knights',  score: 91,  rarity: 'Superstar' },
  // Stars
  { name: 'Mark Scheifele',      team: 'Winnipeg Jets',         score: 90,  rarity: 'Stars'     },
  { name: 'Nick Suzuki',         team: 'Montreal Canadiens',    score: 89,  rarity: 'Stars'     },
  { name: 'Evan Bouchard',       team: 'Edmonton Oilers',       score: 88,  rarity: 'Stars'     },
  { name: 'Cole Caufield',       team: 'Montreal Canadiens',    score: 87,  rarity: 'Stars'     },
  ...
  { name: 'Mika Zibanejad',      team: 'New York Rangers',      score: 80,  rarity: 'Solid'     },
  { name: 'Sam Bennett',         team: 'Florida Panthers',      score: 79,  rarity: 'Solid'     },
  // Bust
  { name: 'Darnell Nurse',       team: 'Edmonton Oilers',       score: 78,  rarity: 'Risk'      },
...
export function rarityAccentGradient(rarity) {
  switch (rarity) {
    ...
    case 'Stars':     return 'from-teal-300 via-emerald-400 to-teal-600';
...
export function rarityCardSkin(rarity) {
  switch (rarity) {
    ...
    case 'Stars':
      return 'bg-gradient-to-br from-teal-300 via-emerald-400 to-teal-700 text-white border-teal-300/70';
    case 'Solid':
...
export function raritySideTone(rarity) {
  switch (rarity) {
    ...
    case 'Stars':
      return 'bg-gradient-to-r from-teal-400/20 via-emerald-500/8 to-transparent border-teal-400/30 text-teal-50';
    case 'Solid':
...
export function rarityGlow(rarity) {
  switch (rarity) {
    ...
    case 'Stars':     return 'rgba(52,211,153,0.45)';
